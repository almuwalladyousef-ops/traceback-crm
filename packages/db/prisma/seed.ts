...
const OWNERS = [
	{ name: "Ada Okafor", email: "ada@traceback.example" },
	{ name: "Marcus Lindqvist", email: "marcus@traceback.example" },
	{ name: "Priya Raman", email: "priya@traceback.example" },
] as const;
